...
class ELR2B2DetailsViewController: UIViewController, SFSafariViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("upgradeconsoleREDIRECT: Redirection to ELR2B2DetailsViewController executed.")
    ...
    @IBAction func buttonWeb(_ sender: UIButton) {
        let safariVC = SFSafariViewController(url: URL(string: "https://www.moe.gov.sg/admissions/direct-admissions/eae/selection-criteria")!)
